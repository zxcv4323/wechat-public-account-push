export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx93567e799df5b5f9",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "0aabe3b6e3b193d61b0955ec167b266c",
   ...
   */
  USERS: [osXdg5zQqpyvYOFsl8IOhDxznmbs]
    {
      // 想要发送的人的名字
      name: "哲哥",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "osXdg5zQqpyvYOFsl8IOhDxznmbs",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "KJeium1ar5PpTKvJTjLyftUO_KssK-dd3U_CQwbuDHI",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "河源",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "KJeium1ar5PpTKvJTjLyftUO_KssK-dd3U_CQwbuDHI",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
